            ...
            <div class="card">
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     <table class="table table-striped table-hover" style="width:100%; white-space:nowrap;" id="t_master">
                        <thead>
                           <tr>
                              <th>Employee No</th>
...
<script>
   ...
   function generate_log() {
      ...
      $.ajax({
         type: "post",
         url: "<?php echo base_url(); ?>transfers/getData",
         data: {
            start: start,
            end: end
         },
   ...
   function getAllLogs() {
      ...
      var table = $('#t_master').DataTable({
         ...
         // serverSide: true,
         ajax: {
            url: "<?php echo base_url(); ?>transfers/getDataLogs2",
            type: "POST",
            data: {
               start: start,
               end: end,
